...
namespace RecipesApi.Controllers
{
    ...
    public class UserController: ControllerBase
    {
        ...
        {
             new User(1, "Yehudit", "Moliver21", "y0556779585@gmail.com", "1111")
        ...
        {
            if (users.Where((u) => u.name == ul.nameUser && u.password ==ul.passwordUser ).Any())
            {
                //המשתמש קיים. מעבר לדף המתכונים
                return 1;
            }
            if (users.Where((u) => u.name == ul.nameUser).Any())
            {
